...
class MyShaderFromRadialGradient: public GShader {
public:
	MyShaderFromRadialGradient(const GPoint& center, float radius, const GColor colors[2]);
...
protected:
	GPoint center, centerTransformed;
	float radius, radiusTransformed = 0;
	GColor colors[2];
